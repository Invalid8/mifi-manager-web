...
import heroImage from "@/assets/img/hero-mifi-image.png";
...
>
  <div className="relative w-full max-w-7xl mx-auto px-6 py-10 flex flex-col lg:flex-row gap-10 lg:gap-20 flex-1">
